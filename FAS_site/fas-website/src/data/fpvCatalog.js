...
export const FPV_PRODUCTS_DATA = [
  {
    ...
    image: "/fpv/7inch.png",
    youtubeId: "",
    description: "Лёгкий и быстрый FPV-квадрокоптер с 7-дюймовыми роторами для задач, где важны манёвренность и высокая скорость.",
    specs: [
  ...
  },
  {
    ...
    youtubeId: "",
    description: "FPV-платформа с 10-дюймовыми роторами для задач с увеличенной нагрузкой и временем полёта.",
    specs: [
  ...
  },
  {
    ...
    image: "/fpv/x8.png",
    youtubeId: "",
    description: "Мощная X8-платформа для транспортировки тяжёлых грузов с высокой устойчивостью и резервированием.",
    specs: [
  ...
  },
  {
    ...
    youtubeId: "",
    description: "Крупный 13-дюймовый квадрокоптер для операций с максимально высокой нагрузкой и длительным зависанием.",
    specs: [
  ...
  },
  {
    ...
    youtubeId: "",
    description: "Специализированный квадрокоптер с управлением и видеоканалом по оптоволоконной линии для защищённых миссий.",
    specs: [
